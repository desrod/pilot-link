...
PalmHeader(char *progname)
{
   ...
   fprintf(stderr, "\n");
   fprintf(stderr, "   (c) Copyright 1996-2000, pilot-link team \n");
   fprintf(stderr, "       Join the pilot-unix list to contribute.\n\n");
   fprintf(stderr, "   This is %s from pilot-link version %d.%d.%d%s\n\n",
	   progname, PILOT_LINK_VERSION, PILOT_LINK_MAJOR, PILOT_LINK_MINOR,
	   patchlevel);
   fprintf(stderr, "   pilot-link %d.%d.%d%s is covered under the GPL\n",
