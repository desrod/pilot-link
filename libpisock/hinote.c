...
void
free_HiNoteNote(struct HiNoteNote *a)
{
   if (a->text)
      free(a->text);
}
...
int
unpack_HiNoteNote(struct HiNoteNote *a, unsigned char *buffer, int len)
{
   if (len < 3)
      return 0;
   a->flags = buffer[0];
...
int
pack_HiNoteNote(struct HiNoteNote *a, unsigned char *buffer, int len)
{
   int destlen;
...
int
unpack_HiNoteAppInfo(struct HiNoteAppInfo *ai, unsigned char *record, int len)
{
   unsigned char *start;
   int i;
   int index;
...
int
pack_HiNoteAppInfo(struct HiNoteAppInfo *ai, unsigned char *record, int len)
{
   int i;
   int index;
