...
static int pi_inet_accept(struct pi_socket *ps, struct sockaddr *addr,
			 int *addrlen);
static int pi_inet_read(struct pi_socket *ps, unsigned char *msg, int len);
static int pi_inet_write(struct pi_socket *ps, unsigned char *msg, int len);
 ...
 ***********************************************************************/
static int
pi_inet_write(struct pi_socket *ps, unsigned char *msg, int len)
{
 ...
 ***********************************************************************/
static int
pi_inet_read(struct pi_socket *ps, unsigned char *msg, int len)
{
	struct pi_inet_data *data = (struct pi_inet_data *)ps->device->data;
	fd_set ready;
	struct timeval t;
