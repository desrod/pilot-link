...
int
cmp_rx(struct pi_socket *ps, struct cmp *c)
{
   int l;
...
int
cmp_init(struct pi_socket *ps, int baudrate)
{
   unsigned char cmpbuf[10];
...
int
cmp_abort(struct pi_socket *ps, int reason)
{
   unsigned char cmpbuf[10];
...
int
cmp_wakeup(struct pi_socket *ps, int maxbaud)
{
