...
extern "C"
{
   ...
   extern int unpack_MailAppInfo
      PI_ARGS((struct MailAppInfo *, unsigned char *AppInfo, int len));

   extern int pack_MailAppInfo
      PI_ARGS((struct MailAppInfo *, unsigned char *AppInfo, int len));

   extern int unpack_MailSyncPref
      PI_ARGS((struct MailSyncPref *, unsigned char *record, int len));

   extern int unpack_MailSignaturePref
      PI_ARGS((struct MailSignaturePref *, unsigned char *record, int len));
