/* getopt_long and getopt_long_only entry points for GNU getopt.
   ...
   with this program; if not, write to the Free Software Foundation, 675
...
/* Like getopt_long, but '-' as well as '--' can indicate a long option.  If
   an option that starts with '-' (not '--') doesn't match a long option,
