...
public class CardInfo {
   ...
   public String toString() {
      return "<org.gnu.pdapilot.CardInfo card " + card + ", version " + version +
             ", romSize " + romSize + ", ramSize " + ramSize +
             ", ramFree " + ramFree + ", name '" + name + 
             "', manufacturer '" + manufacturer + 
             "', created " + ( ( creation == null) ? "null" : creation.toString())+">";
      }
   }
